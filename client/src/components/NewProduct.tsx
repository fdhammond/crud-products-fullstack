            ...
            <div className="relative mx-auto w-full max-w-xl animate-[fadeUp_0.45s_ease-out]">
                ...
                <header className="mb-8">
                    ...
                    <p className="mt-3 max-w-md text-base leading-relaxed text-stone-600">
                        Add an item to your catalog. Keep the details clear so the listing looks sharp on the grid.
                    </p>
                    <p className="mt-2 text-sm text-stone-500">
                        Maximum of {MAX_PRODUCTS} products in this demo catalog.
                    </p>
                </header>

                <form
                    onSubmit={handleSubmit}
                    className="space-y-5 rounded-2xl border border-stone-200/80 bg-white/70 p-6 shadow-[0_1px_0_rgba(28,25,23,0.04)] backdrop-blur-md sm:p-8"
                >
                    {error && (
                    ...
                    <div className="space-y-5">
                        <div>
                            ...
                            <input
                                ...
                                placeholder="e.g. Trail Runner Pro"
                        ...
                        <div>
                            ...
                            <input
                                ...
                                placeholder="Short pitch customers will scan first"
                                className={fieldClass}
                                required
                            />
                        </div>
                        ...
                        <div>
                            ...
                            {image ? (
                                ...
                                <p className="mt-2 text-xs text-stone-400">
                                    Paste a public image link to see a live preview.
                                </p>
                            )}
                        </div>
                    </div>
